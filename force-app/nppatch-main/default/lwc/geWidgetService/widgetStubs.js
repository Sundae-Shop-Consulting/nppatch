...
const ALLOCATION_WIDGET_DEVELOPER_NAME_STUBS = {
    ...
    fieldMappingDeveloperNameStubs: ["GAU_Allocation_1_GAU_", "GAU_Allocation_1_Amount_", "GAU_Allocation_1_Percent_"],
};
...
const SOFT_CREDIT_WIDGET_DEVELOPER_NAME_STUBS = {
    ...
    fieldMappingDeveloperNameStubs: ["Opportunity_Conct_Role_1_Role_", "Opportunity_ConRole_1_Contact_"],
};

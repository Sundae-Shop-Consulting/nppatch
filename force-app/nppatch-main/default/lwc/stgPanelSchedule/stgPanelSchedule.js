...
export default class StgPanelSchedule extends LightningElement {
    ...
    labels = {
        ...
        helpUseDatedConversionRates:
            "When enabled, rollup calculations use Dated Exchange Rates for currency conversion instead of the standard exchange rate.",
        dontAutoSchedule: "Don't Auto Schedule Default Jobs",
        helpDontAutoSchedule:
            "When enabled, NPPatch will not automatically schedule default recurring batch jobs. These jobs calculate rollups, update recurring donations, refresh seasonal addresses, and handle errors.",
    };
    ...
    get isLoading() {
        return (
            !this._settingsCRLP || !this._settingsRD || !this._settingsLvl || !this._settingsHH || !this._settingsErr
        );
    }
    ...
    async handleSave() {
        ...
        try {
            ...
            await saveSettings({
                ...
                fieldValues: {
                    Don_t_Auto_Schedule_Default_NPPatch_Jobs__c:
                        this._workingCopyErr.Don_t_Auto_Schedule_Default_NPPatch_Jobs__c,
                },
            });

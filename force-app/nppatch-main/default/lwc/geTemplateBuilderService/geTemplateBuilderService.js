...
class GeTemplateBuilderService {
        ...
        return new Promise((resolve, reject) => {
            getFieldMappingSet({ fieldMappingSetName: fieldMappingSetName, includeUtilityFields: true })
                .then((data) => {
                    ...
                    this.fieldMappingByDevName = mutable(data.fieldMappingByDevName);
                    this.objectMappingByDevName = mutable(data.objectMappingByDevName);
                    this.fieldMappingsByObjMappingDevName = mutable(data.fieldMappingsByObjMappingDevName);

                    this.addWidgetsPlaceholder(
    ...
    addWidgetsPlaceholder = (fieldMappingByDevName, objectMappingByDevName, fieldMappingsByObjMappingDevName) => {
        ...
        fieldMappingByDevName.geFormWidgetSoftCredit = GeWidgetService.definitions.geFormWidgetSoftCredit;

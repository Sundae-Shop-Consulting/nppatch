...
export default class geBatchWizard extends NavigationMixin(LightningElement) {
    ...
    setFormFieldsBatchLevelDefaults() {
        ...
        const batchLevelDefaults = JSON.parse(
    ...
    setValuesForSelectedBatchHeaderFields(allFields) {
        this.selectedBatchHeaderFields.forEach((batchHeaderField) => {
    ...
    buildCreateRecord() {
        ...
        const newRecordInput = generateRecordInputForCreate(
            this.dataImportBatchCreateDefaults.data.record,
            dataImportBatchObjectInfo
        );
        return this.setFieldValues(newRecordInput);
    }
    ...
    buildUpdateRecord() {
        const dataImportBatchObjectInfo = this.dataImportBatchCreateDefaults.data.objectInfos[this.dataImportBatchName];
        const existingRecordInput = generateRecordInputForUpdate(this.dataImportBatchRecord, dataImportBatchObjectInfo);
        existingRecordInput.apiName = this.dataImportBatchRecord.apiName;
        return this.setFieldValues(existingRecordInput);
    }

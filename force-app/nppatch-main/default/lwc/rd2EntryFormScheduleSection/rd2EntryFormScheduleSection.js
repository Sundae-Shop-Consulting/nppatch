...
export default class rd2EntryFormScheduleSection extends LightningElement {
     ...
     */
    buildFieldDescribes() {
        const { fields: rdFields, apiName } = this.rdObjectInfo;
        return Object.keys(rdFields).map((fieldApiName) => {
            return {
    ...
    extractFieldInfo(fieldInfos, fldApiName) {
        try {
            ...
            // Field info doesn't exist or isn't accessible; return undefined
        }
        return undefined;
    }

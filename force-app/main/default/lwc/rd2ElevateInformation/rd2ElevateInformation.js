...
import FIELD_CC_EXP_MONTH from '@salesforce/schema/Recurring_Donation__c.CardExpirationMonth__c';
import FIELD_CC_EXP_YEAR from '@salesforce/schema/Recurring_Donation__c.CardExpirationYear__c';
import FIELD_CC_LAST_4 from '@salesforce/schema/Recurring_Donation__c.CardLast4__c';
import FIELD_ACH_LAST_4 from '@salesforce/schema/Recurring_Donation__c.ACH_Last_4__c';
import FIELD_STATUS_REASON from '@salesforce/schema/Recurring_Donation__c.ClosedReason__c';
import FIELD_NEXT_DONATION_DATE from '@salesforce/schema/Recurring_Donation__c.Next_Payment_Date__c';
import FIELD_RD_ACCOUNT_NAME from '@salesforce/schema/Recurring_Donation__c.Organization__r.Name';
import FIELD_RD_PRIMARY_CONTACT_LAST_NAME from '@salesforce/schema/Recurring_Donation__c.Organization__r.One2OneContact__r.LastName';
...
import FIELD_RD_CONTACT_ID from '@salesforce/schema/Recurring_Donation__c.Contact__c';
import FIELD_RD_ACCOUNT_ID from '@salesforce/schema/Recurring_Donation__c.Organization__c';

...
export default class bdiObjectMappingModal extends LightningElement {
    ...
    excludedDIFields = ['ownerid',
                    '%%%NAMESPACE%%%ApexJobId__c',
                    '%%%NAMESPACE%%%Campaign_Member_Status__c',
                    '%%%NAMESPACE%%%DonationCampaignImportStatus__c',
                    '%%%NAMESPACE%%%DonationCampaignImported__c',
                    '%%%NAMESPACE%%%Donation_Campaign_Name__c',
                    '%%%NAMESPACE%%%Donation_Donor__c',
